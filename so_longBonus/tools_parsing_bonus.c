...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   tools_parsing_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aennaqad <aennaqad@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/15 21:06:18 by aennaqad          #+#    #+#             */
/*   Updated: 2024/02/27 14:05:54 by aennaqad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	printmoves(t_tool *var)
{
	...
	mlx_put_image_to_window(var->var_mlx.mlx, var->var_mlx.win,
		var->var_mlx.wall, 0, 0);
	mlx_put_image_to_window(var->var_mlx.mlx, var->var_mlx.win,
		var->var_mlx.wall, 64, 0);
